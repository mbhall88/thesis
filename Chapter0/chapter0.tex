...
\noindent
All of the exisiting methods require an enfored structure - i.e., loci are not unlinked and order is assumed. VG has been applied to bacterial for strain-typing and abundance estimates in \ecoli{}, however, individual graphs had to be concatenated together for each gene, enforcing an order \cite{strainflair2021}.
