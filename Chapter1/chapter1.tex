...
In addition, many components of the pipeline to run the analysis in \autoref{sec:denovo-empirical} and \cite{pandora} were originally implemented by myself, but were later refactored or changed by Leandro.
