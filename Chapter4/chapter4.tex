...
% That's fine Michael. I can point you towards this paper we published with the sample preparation details: https://pubmed.ncbi.nlm.nih.gov/32719032/ (I haven't got access to my old MMM files atm). The BCG run data you used was direct from MGIT culture (not spiked into human sputum) and was run as a single sample on a flow cell. 
...
\section{Future work}
\label{sec:tubby-fw}
% de novo assembly assessment instead of reference-guided
% DCm motifs could be replaced with Mtb specific ones https://elifesciences.org/articles/58542
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
