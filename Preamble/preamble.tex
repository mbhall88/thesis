...
% add a source element for figures and tables - taken from https://tex.stackexchange.com/questions/95029/add-source-to-figure-caption
\newcommand{\source}[1]{\caption*{\tiny\textbf{Source}: {#1}} }

% allow linebreaks in URLs https://tex.stackexchange.com/questions/3033/forcing-linebreaks-in-url
\usepackage{xurl}
...
% numeric-comp compressed and sorts in-text citation numbers. sorting=none sorts the bibliograph based on when the citation first appears in the text
...
\newcommand{\map}{\pandora{} \texttt{map}}
\newcommand{\drprg}{\vrb{drprg}}
\newcommand{\mykrobe}{\vrb{mykrobe}}
\newcommand{\xpert}{Xpert\textsuperscript{\textregistered}}
...
\nomenclature[z-PanRG]{\panrg}{Pan-genome Reference Graph. A collection of \prg{}s}
...
\nomenclature[z-AvgAR]{AvgAR}{Average allelic recall}
\nomenclature[z-indel]{indel}{Insertion/deletion}
\nomenclature[z-MDR]{MDR}{Multi-drug resistant}
