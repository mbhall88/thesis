...
It has previously been shown that deep coverage is required of \ont{} to accurately predict drug resistance \cite{Votintseva2017}. As Nanopore sequencing advances quickly, and our dataset contains a broad depth-of-coverage range (~29-150x) we explore whether this requirement of high coverage still holds.
