...
\drprg{} has two distinct phases. In the first phase, we build an index and \panrg{} from a panel (catalogue) of mutations known to cause resistance or susceptibility. Second, we genotype Illumina or \ont{} reads against the \panrg{}, and phenotype predictions are made for the drugs in the provided panel.
