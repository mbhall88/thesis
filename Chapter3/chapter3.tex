...
If the variant call was not deemed unknown or failed in the previous step, and it has overlapping panel variants, we check if there is a match between the call and a panel allele. To determine if there is a match between the called allele and any of the overlapping panel variant's alleles, we ...
