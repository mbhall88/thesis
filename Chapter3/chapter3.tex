...
Drug resistance predictions from WGS data are now a standard routine for an increasing number of public health agencies. In particular, a suscpetible prediction for first-line drugs is now considered accurate enough for clinical use \cite{cryptic2018}.
...
\subsection{Panel improvement}

The panel (catalogue) describing the consequence of each mutation is a vital component of any AMR prediction program, and can be the primary point-of-difference between tools \cite{hunt2019}. For the work in this chapter, we used the default mykrobe panel for \drprg{}. There are two changes to the \drprg{} p

\subsubsection{Synonomous mutations}

\subsubsection{WHO panel}
% who panel
The WHO has recently released a curated catalogue of \mtb{} mutations and their associated impact on drug susceptibility \cite{whopanel2021}. Incorporating such a panel into the one used in this chapter would likely 

\subsection{Validation on a larger and more diverse dataset}
